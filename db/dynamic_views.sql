...
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastDiseases, 1, 'PID',                              NULL, 0, -5, NULL),
(@lastDiseases, 0, 'DiseaseIdentifier', 'DiseaseIdentifier', 1, -5, NULL),
(@lastDiseases, 0, 'versionID',                 'versionID', 2, -5, NULL),
(@lastDiseases, 0, 'name',                           'name', 3, 12, NULL),
(@lastDiseases, 0, 'name_dk',                     'name_dk', 4, 12, NULL),
(@lastDiseases, 0, 'ATCCode',                     'ATCCode', 5, 12, NULL),
(@lastDiseases, 0, 'ATCText',                     'ATCText', 6, 12, NULL),
(@lastDiseases, 0, 'ddvModifiedDate',     'ddvModifiedDate', 7, 12, NULL),
(@lastDiseases, 0, 'ddvValidFrom',           'ddvValidFrom', 8, 12, NULL),
(@lastDiseases, 0, 'ddvValidTo',               'ddvValidTo', 9, 12, NULL),
(@lastDiseases, 0, 'ModifiedDate',                     NULL, 0, 93, 12),
(@lastDiseases, 0, 'ValidFrom',                 'ValidFrom',10, 93, 12),
(@lastDiseases, 0, 'ValidTo',                     'ValidTo',11, 93, 12);
...
SET @lastDiseasesVacc := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='diseases_vaccines' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastDiseasesVacc, 1, 'PID',                              NULL, 0, -5, NULL),
(@lastDiseasesVacc, 0, 'VaccineIdentifier', 'VaccineIdentifier', 1, -5, NULL),
(@lastDiseasesVacc, 0, 'VaccineVersion',       'VaccineVersion', 2, -5, NULL),
(@lastDiseasesVacc, 0, 'DiseaseIdentifier', 'DiseaseIdentifier', 3, -5, NULL),
(@lastDiseasesVacc, 0, 'DiseaseVersion',       'DiseaseVersion', 4, -5, NULL),
(@lastDiseasesVacc, 0, 'ddvModifiedDate',     'ddvModifiedDate', 5, 12, NULL),
(@lastDiseasesVacc, 0, 'ddvValidFrom',           'ddvValidFrom', 6, 12, NULL),
(@lastDiseasesVacc, 0, 'ddvValidTo',               'ddvValidTo', 7, 12, NULL),
(@lastDiseasesVacc, 0, 'ModifiedDate',                     NULL, 0, 93, 12),
(@lastDiseasesVacc, 0, 'ValidFrom',                 'ValidFrom', 8, 93, 12),
(@lastDiseasesVacc, 0, 'ValidTo',                     'ValidTo', 9, 93, 12);
...
SET @lastDosOpt := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='dosageoptions' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastDosOpt, 1, 'PID',                                        NULL, 0, -5, NULL),
(@lastDosOpt, 0, 'DosageoptionIdentifier', 'DosageoptionIdentifier', 1, -5, NULL),
(@lastDosOpt, 0, 'VersionID',                           'VersionID', 2, -5, NULL),
(@lastDosOpt, 0, 'DrugIdentifier',                 'DrugIdentifier', 3, -5, NULL),
(@lastDosOpt, 0, 'DrugName',                             'DrugName', 4, 12, NULL),
(@lastDosOpt, 0, 'DosageText',                         'DosageText', 5, 12, NULL),
(@lastDosOpt, 0, 'ddvModifiedDate',               'ddvModifiedDate', 6, 12, NULL),
(@lastDosOpt, 0, 'ddvValidFrom',                     'ddvValidFrom', 7, 12, NULL),
(@lastDosOpt, 0, 'ddvValidTo',                         'ddvValidTo', 8, 12, NULL),
(@lastDosOpt, 0, 'ModifiedDate',                               NULL, 0, 93, 12),
(@lastDosOpt, 0, 'ValidFrom',                           'ValidFrom', 9, 93, 12),
(@lastDosOpt, 0, 'ValidTo',                               'ValidTo',10, 93, 12);
...
SET @lastssiDrug := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='ssidrugs' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastssiDrug, 1, 'PID',                         NULL, 0, -5, NULL),
(@lastssiDrug, 0, 'DrugIdentifier',  'DrugIdentifier', 1, -5, NULL),
(@lastssiDrug, 0, 'VersionID',            'VersionID', 2, -5, NULL),
(@lastssiDrug, 0, 'Name',                      'Name', 3, 12, NULL),
(@lastssiDrug, 0, 'FormTekst',            'FormTekst', 4, 12, NULL),
(@lastssiDrug, 0, 'ATCCode',                'ATCCode', 5, 12, NULL),
(@lastssiDrug, 0, 'ATCText',                'ATCText', 6, 12, NULL),
(@lastssiDrug, 0, 'StyrkeTekst',        'StyrkeTekst', 7, 12, NULL),
(@lastssiDrug, 0, 'UsableFrom',          'UsableFrom', 8, 12, NULL),
(@lastssiDrug, 0, 'UsableTo',              'UsableTo', 9, 12, NULL),
(@lastssiDrug, 0, 'ddvModifiedDate','ddvModifiedDate',10, 12, NULL),
(@lastssiDrug, 0, 'ddvValidFrom',      'ddvValidFrom',11, 12, NULL),
(@lastssiDrug, 0, 'ddvValidTo',          'ddvValidTo',12, 12, NULL),
(@lastssiDrug, 0, 'ModifiedDate',                NULL, 0, 93, 12),
(@lastssiDrug, 0, 'ValidFrom',            'ValidFrom',13, 93, 12),
(@lastssiDrug, 0, 'ValidTo',                'ValidTo',14, 93, 12);
...
SET @lastVaccPlanItems := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='vaccinationplanitems' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastVaccPlanItems, 1, 'PID',                                                     NULL, 0, -5, NULL),
(@lastVaccPlanItems, 0, 'VaccinationPlanItemIdentifier','VaccinationPlanItemIdentifier', 1, -5, NULL),
(@lastVaccPlanItems, 0, 'VersionID',                                        'VersionID', 2, -5, NULL),
(@lastVaccPlanItems, 0, 'VaccineIdentifier',                        'VaccineIdentifier', 3, -5, NULL),
(@lastVaccPlanItems, 0, 'VaccineName',                                    'VaccineName', 4, 12, NULL),
(@lastVaccPlanItems, 0, 'VaccinationIndex',                          'VaccinationIndex', 5, -5, NULL),
(@lastVaccPlanItems, 0, 'MinimumInterval',                            'MinimumInterval', 6, -5, NULL),
(@lastVaccPlanItems, 0, 'CoverageDuration',                          'CoverageDuration', 7, 12, NULL),
(@lastVaccPlanItems, 0, 'Time',                                                  'Time', 8, -5, NULL),
(@lastVaccPlanItems, 0, 'Description',                                    'Description', 9, 12, NULL),
(@lastVaccPlanItems, 0, 'Series',                                              'Series',10, 12, NULL),
(@lastVaccPlanItems, 0, 'VaccinationPlanIdentifier',        'VaccinationPlanIdentifier',11, -5, NULL),
(@lastVaccPlanItems, 0, 'PlanVersionID',                                'PlanVersionID',12, -5, NULL),
(@lastVaccPlanItems, 0, 'ddvModifiedDate',                            'ddvModifiedDate',13, 12, NULL),
(@lastVaccPlanItems, 0, 'ddvValidFrom',                                  'ddvValidFrom',14, 12, NULL),
(@lastVaccPlanItems, 0, 'ddvValidTo',                                      'ddvValidTo',15, 12, NULL),
(@lastVaccPlanItems, 0, 'ModifiedDate',                                            NULL, 0, 93, 12),
(@lastVaccPlanItems, 0, 'ValidFrom',                                        'ValidFrom',16, 93, 12),
(@lastVaccPlanItems, 0, 'ValidTo',                                            'ValidTo',17, 93, 12);
...
SET @lastVaccPlan := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='vaccinationplan' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastVaccPlan, 1, 'PID',                         NULL, 0, -5, NULL),
(@lastVaccPlan, 0, 'VaccinationPlanIdentifier','VaccinationPlanIdentifier', 1, -5, NULL),
(@lastVaccPlan, 0, 'VersionID',                                'VersionID', 2, -5, NULL),
(@lastVaccPlan, 0, 'Active',                                      'Active', 3, -5, NULL),
(@lastVaccPlan, 0, 'Name',                                          'Name', 4, 12, NULL),
(@lastVaccPlan, 0, 'UsableFrom',                              'UsableFrom', 5, 12, NULL),
(@lastVaccPlan, 0, 'UsableTo',                                  'UsableTo', 6, 12, NULL),
(@lastVaccPlan, 0, 'AllocationMethod',                  'AllocationMethod', 7, 12, NULL),
(@lastVaccPlan, 0, 'Sex',                                            'Sex', 8, 12, NULL),
(@lastVaccPlan, 0, 'BirthCohorteFrom',                  'BirthCohorteFrom', 9, 93, NULL),
(@lastVaccPlan, 0, 'BirthCohorteTo',                      'BirthCohorteTo',10, 93, NULL),
(@lastVaccPlan, 0, 'AgeIntervalFrom',                    'AgeIntervalFrom',11, -5, NULL),
(@lastVaccPlan, 0, 'AgeIntervalTo',                        'AgeIntervalTo',12, -5, NULL),
(@lastVaccPlan, 0, 'ddvModifiedDate',                    'ddvModifiedDate',13, 12, NULL),
(@lastVaccPlan, 0, 'ddvValidFrom',                          'ddvValidFrom',14, 12, NULL),
(@lastVaccPlan, 0, 'ddvValidTo',                              'ddvValidTo',15, 12, NULL),
(@lastVaccPlan, 0, 'ModifiedDate',                                    NULL, 0, 93, 12),
(@lastVaccPlan, 0, 'ValidFrom',                                'ValidFrom',16, 93, 12),
(@lastVaccPlan, 0, 'ValidTo',                                    'ValidTo',17, 93, 12);
...
SET @lastVaccs := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='vaccines' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastVaccs, 1, 'PID',                                            NULL, 0, -5, NULL),
(@lastVaccs, 0, 'VaccineIdentifier',               'VaccineIdentifier', 1, -5, NULL),
(@lastVaccs, 0, 'VersionID',                               'VersionID', 2, -5, NULL),
(@lastVaccs, 0, 'ATCCode',                                   'ATCCode', 3, 12, NULL),
(@lastVaccs, 0, 'ATCText',                                   'ATCText', 4, 12, NULL),
(@lastVaccs, 0, 'ShortDescription',                 'ShortDescription', 5, 12, NULL),
(@lastVaccs, 0, 'AllowCitizenSelfRegister', 'AllowCitizenSelfRegister', 6, -5, NULL),
(@lastVaccs, 0, 'AllowBulkRegister',               'AllowBulkRegister', 7, -5, NULL),
(@lastVaccs, 0, 'Keywords',                                 'Keywords', 8, 12, NULL),
(@lastVaccs, 0, 'SearchBoost',                           'SearchBoost', 9,  3, NULL),
(@lastVaccs, 0, 'ddvModifiedDate',                   'ddvModifiedDate',10, 12, NULL),
(@lastVaccs, 0, 'ddvValidFrom',                         'ddvValidFrom',11, 12, NULL),
(@lastVaccs, 0, 'ddvValidTo',                             'ddvValidTo',12, 12, NULL),
(@lastVaccs, 0, 'ModifiedDate',                                   NULL, 0, 93, 12),
(@lastVaccs, 0, 'ValidFrom',                               'ValidFrom',13, 93, 12),
(@lastVaccs, 0, 'ValidTo',                                   'ValidTo',14, 93, 12);
...
SET @lastVaccsDr := (SELECT idSKRSViewMapping FROM SKRSViewMapping WHERE register='ddv' AND datatype='vaccines_drugs' AND version=1);
INSERT IGNORE INTO SKRSColumns (viewMap, isPID, tableColumnName, feedColumnName, feedPosition, dataType, maxLength) VALUES
(@lastVaccsDr, 1, 'PID',                              NULL, 0, -5, NULL),
(@lastVaccsDr, 0, 'VaccineIdentifier', 'VaccineIdentifier', 1, -5, NULL),
(@lastVaccsDr, 0, 'VersionID',                 'VersionID', 2, -5, NULL),
(@lastVaccsDr, 0, 'DrugIdentifier',       'DrugIdentifier', 3, -5, NULL),
(@lastVaccsDr, 0, 'DrugName',                   'DrugName', 4, 12, NULL),
(@lastVaccsDr, 0, 'ddvModifiedDate',     'ddvModifiedDate', 5, 12, NULL),
(@lastVaccsDr, 0, 'ddvValidFrom',           'ddvValidFrom', 6, 12, NULL),
(@lastVaccsDr, 0, 'ddvValidTo',               'ddvValidTo', 7, 12, NULL),
(@lastVaccsDr, 0, 'ModifiedDate',                     NULL, 0, 93, 12),
(@lastVaccsDr, 0, 'ValidFrom',                 'ValidFrom', 8, 93, 12),
(@lastVaccsDr, 0, 'ValidTo',                     'ValidTo', 9, 93, 12);
...
(@lastPakning, 0, 'DrugID',                                               'drugId', 3,   3, NULL),
