...
public class PakningFactory implements FixedLengthParserConfiguration<Pakning>
{
	...
	public void setFieldValue(Pakning obj, int fieldNo, String value) throws Exception
	{
		...
		case 1:
			...
			break;
		case 2:
			obj.setAlfabetSekvensnr(NumberUtils.createLong(value));
			break;
		case 3:
			obj.setVarenummerForDelpakning(NumberUtils.createLong(value));
			break;
		case 4:
			obj.setAntalDelpakninger(NumberUtils.createLong(value));
			break;
		case 5:
			obj.setPakningsstoerrelseKlartekst(value);
			break;
		case 6:
			obj.setPakningsstoerrelseNumerisk(NumberUtils.createLong(value));
			break;
		case 7:
		...
		case 12:
			...
			break;
		case 13:
			obj.setAntalDDDPrPakning(NumberUtils.createLong(value));
			break;
		case 14:
		...
		case 22:
			...
			break;
		case 24:
			obj.setPakningsdistributoer(NumberUtils.createLong(value));
			break;
		default:
			break;
		}
