...
public class AdministrationsvejFactory implements FixedLengthParserConfiguration<Administrationsvej>
{
	@Override
	...
	@Override
	public void setFieldValue(Administrationsvej obj, int fieldNo, String value)
	{
		switch (fieldNo)
		{
		case 0:
