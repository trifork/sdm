...
public class FatcherProvider implements Provider<Fetcher>
{
	...
	private static final String JDBC_URL_PROP = "db.connection.username";
	
	private final SessionFactory sessionFactory;
	
	@Inject
	FatcherProvider(@Named(JDBC_URL_PROP) String jdbcURL, @Named(USERNAME_PROP) String username, @Named(PASSWORD_PROP) @Nullable String password)
	{
