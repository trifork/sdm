...
/**
 * Person mapper for wsdl version 1.0.2
 */
@RequestScoped
public class PersonMapper extends dk.nsi.stamdata.cpr.mapping.PersonMapper {
    ...
    public PersonInformationStructureType map(Person person, ServiceProtectionLevel protectionLevel, CPRProtectionLevel cprProtection) {
        ...
        return (censorData) ? createOutputWithCensoredDate(person, cprProtection) : createOutputWithRealData(person);
    }
    ...
    private PersonInformationStructureType createOutputWithRealData(Person person) {
        ...
        if (shouldIncludeAddress) {
            ...
            // KPN I think it should be bynavn ...
            ...
            // TODO Country code should be mapped here
    ...
    public PersonWithHealthCareInformationStructureType map(Person person, @Nullable Record sikredeRecord, @Nullable Record yderRecord)
        ...
        if (isPersonProtected(person)) {
            ...
            SikredeRecordToPersonPublicHealthInsuranceMapper sikredeRecordToPersonPublicHealhInsuranceMapper =
                    new SikredeRecordToPersonPublicHealthInsuranceMapper();
