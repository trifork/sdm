...
import com.trifork.stamdata.jaxws.GuiceInstanceResolver;
...
import dk.nsi.stamdata.jaxws.generated102.*;
...
@WebService(endpointInterface="dk.nsi.stamdata.jaxws.generated102.DetGodeCPROpslag")
@GuiceInstanceResolver.GuiceWebservice
@SchemaValidation
public class DetGodeCPROpslagImpl102 extends DetGodCPROpslagBase implements DetGodeCPROpslag
{
    ...
    @Inject
    DetGodeCPROpslagImpl102(Fetcher fetcher, RecordFetcher recordFetcher, PersonMapper personMapper, SystemIDCard card, SLALogItem slaLogItem)
    {
    ...
    public GetPersonWithHealthCareInformationOut getPersonWithHealthCareInformation(
            ...
            @WebParam(name = "getPersonWithHealthCareInformationIn", targetNamespace = NS_DET_GODE_CPR_OPSLAG_102, partName = "parameters") GetPersonWithHealthCareInformationIn parameters)
            throws DGWSFault
    {
        //
        return null;
    ...
    public GetPersonInformationOut getPersonInformation(
            ...
            @WebParam(name = "getPersonInformationIn", targetNamespace = NS_DET_GODE_CPR_OPSLAG_102, partName = "parameters") GetPersonInformationIn parameters)
            throws DGWSFault {
        //
        return null;
    }
