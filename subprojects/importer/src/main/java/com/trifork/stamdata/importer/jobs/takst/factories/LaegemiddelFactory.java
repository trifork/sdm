...
public class LaegemiddelFactory extends AbstractFactory
{
	...
	public static ArrayList<Laegemiddel> read(File rootDir) throws IOException
	{
		File file = new File(rootDir, getLmsName().toLowerCase() + ".txt");
		...
		try
		{
			reader = new BufferedReader(new InputStreamReader(new FileInputStream(file), "CP865"));
			while (reader.ready())
			{
