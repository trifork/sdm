...
public class SubstitutionAfLaegemidlerUdenFastPrisFactory extends AbstractFactory
{
	...
	private static void setFieldValue(SubstitutionAfLaegemidlerUdenFastPris obj, int fieldNo,
			String value)
	{
	...
	public static ArrayList<SubstitutionAfLaegemidlerUdenFastPris> read(String rootFolder)
			throws IOException
	{
