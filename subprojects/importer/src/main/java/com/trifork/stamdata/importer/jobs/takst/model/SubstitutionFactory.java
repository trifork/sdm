...
public class SubstitutionFactory implements FixedLengthParserConfiguration<Substitution>
{
	...
	public void setFieldValue(Substitution obj, int fieldNo, String value)
	{
		...
		{
		case 0:
			obj.setSubstitutionsgruppenummer(Long.parseLong(value));
			break;
		case 1:
			obj.setReceptensVarenummer(Long.parseLong(value));
			break;
		case 2:
			obj.setNumeriskPakningsstoerrelse(Long.parseLong(value));
			break;
		case 3:
		...
		case 5:
			...
			break;
		case 6:
			obj.setBilligsteVarenummer(Long.parseLong(value));
			break;
		}
	}
}
