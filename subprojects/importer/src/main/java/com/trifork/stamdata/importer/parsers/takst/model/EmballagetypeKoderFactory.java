...
public class EmballagetypeKoderFactory implements FixedLengthParserConfiguration<EmballagetypeKoder>
{
	@Override
	...
	@Override
	public void setFieldValue(EmballagetypeKoder obj, int fieldNo, String value)
	{
		switch (fieldNo)
		{
		case 0:
