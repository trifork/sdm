...
public class Laegemiddel extends TakstEntity {
    ...
    public String getDatoForAfregistrAfLaegemiddel() {
        ...
        try {
            ...
            logger.error("Error converting DatoForAfregistrAfLaegemiddel to iso 8601 date format. Value was: \"" + this.datoForAfregistrAfLaegemiddel + "\". Returning unformated string: '"
    ...
    public String getKarantaenedato() {
        if (this.karantaenedato == null || "".equals(this.karantaenedato))
            return null;
        SimpleDateFormat informat = new SimpleDateFormat("yyyyMMdd");
        SimpleDateFormat outformat = new SimpleDateFormat("yyyy-MM-dd");
        try {
    ...
    /*
      * tom@trifork.com: Doseringer vil jeg nok udelade lige nu, her er vi ved at lave store ændringer (evt. kan du bare
      * udkommentere koden i første omgang, hvis vi fortryder)
      */
