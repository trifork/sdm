...
public class FileSpoolerSetupTest {
    ...
    public void runSetupTest() throws Exception {
        ...
        FileSpoolerSetup setup = new FileSpoolerSetup("TestSpooler", spoolerDir, TstFileImporter.class);
        ...
        Assert.assertEquals(setup.getImporterClass(), TstFileImporter.class);
