 ...
 *         &lt;element ref="{urn:oio:sagdok:person:1.0.0}ErstatttetAf" maxOccurs="unbounded" minOccurs="0"/>
...
public class RelationListeType {
    ...
    protected List<PersonFlerRelationType> foraeldremyndighedsindehaver;
    ...
    @XmlElement(name = "ErstatttetAf")
    protected List<PersonRelationType> erstatttetAf;
     ...
     * 
     */
    public List<PersonFlerRelationType> getForaeldremyndighedsindehaver() {
        if (foraeldremyndighedsindehaver == null) {
            foraeldremyndighedsindehaver = new ArrayList<PersonFlerRelationType>();
        }
    ...
    /**
     * Gets the value of the erstatttetAf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the erstatttetAf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErstatttetAf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PersonRelationType> getErstatttetAf() {
        if (erstatttetAf == null) {
            erstatttetAf = new ArrayList<PersonRelationType>();
        }
        return this.erstatttetAf;
    }
