...
public class PermissionDao {
	...
	@Inject
	public PermissionDao(@Transactional(ADMINISTRATION) Provider<Connection> connectionProvider) {
	...
	@Transactional(ADMINISTRATION)
	public boolean canAccessEntity(String cvrNumber, String entityName) throws SQLException {
		PreparedStatement statement = null;
		...
		try {
			...
			statement.setString(2, cvrNumber);
			ResultSet resultSet = statement.executeQuery();
