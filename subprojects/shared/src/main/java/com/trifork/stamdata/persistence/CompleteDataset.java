...
/**
 * A Dataset that is the complete truth within the given validfrom-validto interval. That is, no
 * other records are allowed other than the ones in this dataset.
 */
